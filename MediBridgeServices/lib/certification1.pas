...
uses CommonDefinitions, InvokeRegistry, SOAPHTTPClient, Types, XSBuiltIns;
...
begin
  ...
  // force timeout to 5 minutes
  HTTPReqResp1 := THTTPReqResp.Create(nil);
  HTTPReqResp1.ConnectTimeout := 5 * 60 * 1000;
